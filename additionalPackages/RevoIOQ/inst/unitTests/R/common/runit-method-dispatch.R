...
"method.dispatch.stress" <- function()
{
...
"test.method.dispatch.stress" <- function()
{
    res <- try(method.dispatch.stress())
    checkTrue(!is(res, "try-error"), msg="method.dispatch stress test failed")    
}
