...
"test.array.subset.stress" <- function()
{
    res <- try(array.subset.stress())
    checkTrue(!is(res, "try-error"), msg="array-subset stress test failed")    
}
